...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        `bg-background fixed left-[50%] top-[50%] z-50 max-h-[90vh] max-w-[95vw]
        translate-x-[-50%] translate-y-[-50%] gap-4 overflow-y-auto border p-6 shadow-lg
        ...
        data-[state=open]:slide-in-from-top-[48%] sm:rounded-lg md:grid md:max-w-4xl`,
        className
      )}
      {...props}
    >
      ...
      >
        <X className="h-5 w-5 2xl:h-8 2xl:w-8" />
